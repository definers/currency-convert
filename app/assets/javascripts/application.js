...
var loadData = function(data, url){
    $.ajax({
        ...
        success: function(data){
            if( data != null){
                var conversioRateArr = getCurrencyRates(data);
                drawChartForEachCurrency(conversioRateArr);
                drawChartForAllCurrency(conversioRateArr);
            }else{
...
function getCurrencyRates(data) {
    ...
    return conversioRateArr
}

function drawChartForEachCurrency(conversioRateArr){
    for(i = 0; i < conversioRateArr.length-1; i++){
        var chartId= 'chart'+i;
...
function drawChartForAllCurrency(conversioRateArr) {
    var Id = conversioRateArr.length;
